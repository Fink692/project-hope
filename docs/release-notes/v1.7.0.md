...
7. Complete the synthetic enrollment, fresh-browser challenge, recovery-code, operator-reset, and key-rotation checks in [production deployment](../operations/production-deployment.md).
