...
| Accessibility | Semantic responsive web foundation, visible focus, reduced-motion support, transformation/review records, and [v1.7 automated/browser-assisted evidence](accessibility-audit-v1.7.md) | Manual WCAG 2.2 AA audit, screen-reader/keyboard/zoom testing, tagged export validation, testing with users with disabilities |
